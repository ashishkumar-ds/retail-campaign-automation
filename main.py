...
# CAMPAIGN BENCHMARK VALIDATION
#
def validate_campaign_benchmark() -> dict:

    benchmark_sales_uplift = 10.7

    return {
        "benchmark_sales_uplift": benchmark_sales_uplift,
        "rollout_decision": "ADVANCE_PHASE",
        "validation_reason": (
            "Campaign 18 historical benchmark "
            "supports rollout expansion."
        )
    }
